...
The shogoa design language provides a simple way to describe an API design. The language consists of
...
This description can also include JSON schema-like validation rules that shogoa uses to produce
...
shogoa to render the "links" child attributes.
...
validation rules that shogoa leverages to validate attributes of that type.
