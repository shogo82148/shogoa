...
import (
	...
	genjs "github.com/shogo82148/shogoa/shogoagen/gen_js"
	"github.com/shogo82148/shogoa/version"
)

var _ = Describe("Generate", func() {
	const testgenPackagePath = "github.com/shogo82148/shogoa/shogoagen/gen_js/test_"
	...
	BeforeEach(func() {
		...
		os.Args = []string{"shogoagen", "--out=" + outDir, "--design=foo", "--host=baz", "--version=" + version.String()}
	})
