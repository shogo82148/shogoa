...
import (
	...
	"github.com/shogo82148/shogoa/shogoagen/meta"
	"github.com/shogo82148/shogoa/shogoagen/utils"
	"github.com/shogo82148/shogoa/version"
	"github.com/spf13/cobra"
	"github.com/spf13/pflag"

	// These are packages required by the generated code but not by shogoagen.
...
func main() {
	...
	// rootCmd is the base command used when shogoagen is called with no argument.
	rootCmd := &cobra.Command{
		Use:   "shogoagen",
		Short: "shogoa code generation tool",
		Long: `The shogoagen tool generates artifacts from a shogoa service design package.
...
`}
	...
	versionCmd := &cobra.Command{
		Use:   "version",
		Short: "Print the version number of shogoagen",
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Println("shogoagen " + version.String() + "\nThe shogoa generation tool.")
		},
	}
	...
	controllerCmd.Flags().StringVar(&appPkg, "app-pkg", "app", "`import path` of Go package generated with 'shogoagen app', may be relative to output")
...
func run(pkg string, c *cobra.Command) ([]string, error) {
	pkgPath := fmt.Sprintf("github.com/shogo82148/shogoa/shogoagen/gen_%s", pkg[3:])
...
// Remember to update as shogoagen commands and flags evolve
//
